        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 ">
          <div ref={modalRef} className="rounded-2xl relative max-w-4xl w-full animate-fadeInUp">
            ...
            >
              ...
              ></iframe> */}
              <video src={'https://res.cloudinary.com/dgikemsx7/video/upload/f_auto:video,q_auto/p6imde1imaphx7uicasv '} autoPlay loop controls className='w-full h-full rounded-2xl'>
