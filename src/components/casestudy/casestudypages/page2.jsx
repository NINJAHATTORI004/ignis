  ...
  const Page2Data = {
    ...
    creation: {
      ...
      description: `
        ...
        - A mental health awareness campaign to reduce stigma.
        - A 24/7 crisis helpline and an online mental health resources portal.
        These strategies provide students with the tools they need to manage stress and maintain mental health.
      `,
    },
    activation: {
      name: "Positive Impact on Student Well-being",
      ...
      description: `
        ...
        - Fewer crisis situations due to accessible immediate support.
        IgnisMentis holistic approach has fostered a resilient and connected student body.
      `,
    },
  };
