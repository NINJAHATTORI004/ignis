  ...
  return (
    <div>
      ...
      >
        ...
        <p>
        Ignis Mentis provides support services to students at risk of dropping out, including predictive modeling, AI-driven mentorship, mental health resources, scholarship assistance, and more. The services offered may evolve to meet student needs, and any changes will be communicated via our website.
        </p>

        <h2><strong>3. User Obligations</strong></h2>
        <p> </p>
        <p> You agree to use our services solely for their intended purpose of providing educational and mental health support to students and not for any unlawful or unauthorized purposes. You shall not:</p>

        <ul>
          <li>* Use the services to copy, reproduce, modify, or distribute any content without prior written consent from Ignis Mentis.</li>
          <li>* Engage in any disruptive, harmful, or abusive behavior towards our platform, community members, or mentors.</li>
          <li>* Share your account information with unauthorized individuals or allow unauthorized users to access your account.</li>
        </ul>

        <h2><strong>4. Intellectual Property</strong></h2>
        <p>
        All content, trademarks, and intellectual property on our website are owned by or licensed to Ignis Mentis. You may not reproduce, distribute, or modify any content without our express written consent.
        </p>

        <h2><strong>5. Use of Work</strong></h2>
        <p>
        By utilizing our services, you agree that anonymized data and feedback may be used by Ignis Mentis to improve platform functionality, promote services, or develop case studies. This usage will always maintain user anonymity and confidentiality, unless otherwise agreed upon in writing.
        </p>

        <h2><strong>6. Limitation of Liability</strong></h2>
        <p>
        Ignis Mentis shall not be liable for any damages arising from the use or inability to use our services. Our total liability is limited to the amount paid (if applicable) for the services. While we strive to ensure the accuracy and usefulness of our tools and content, we do not guarantee specific results or outcomes.
        </p>

        <h2><strong>7. Changes to Terms</strong></h2>
        <p>
        Ignis Mentis reserves the right to change these Terms at any time. Updates will be posted on this page, and it is your responsibility to review them periodically. Continued use of the services following any changes constitutes acceptance of the new Terms.
        </p>

        <h2><strong>8. Cancellation and Refund Policy</strong></h2>
        <p>If you wish to cancel or request a refund for any paid services, please refer to your specific service agreement. Requests will be reviewed on a case-by-case basis by our support team.</p>

        <h2><strong>9. Governing Law</strong></h2>
        <p>These Terms are governed by the laws of [specify region, e.g., your location's jurisdiction]. Any disputes arising from these Terms or your use of our services will be resolved in accordance with the applicable laws of this region.</p>
